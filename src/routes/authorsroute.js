...
const authors = require('../data/authors'); //Part #2 Point 6 : added the entire line
...
authorsRouter.post('/add', function (req, res) {
    ...
    var item={
       ...
       // image:req.body.images, //Part #2 Point 8: images changed to image
...
authorsRouter.post('/update', function (req, res) { 
    ...
    //authordata.findByIdAndUpdate(req.body.id, { $set: req.body }, function (err, data) { // Part #2 Point 9
